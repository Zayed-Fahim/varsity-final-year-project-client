  ...
  const handleLogin = (data) => {
    signIn(data.email, data.password)
      .then((result) => {
        ...
        toast.success("Successfully login into your student account");
      })
          ...
          <div className="md:flex w-full">
            ...
            >
              <div className="text-center mb-10">
                <h1 className="xl:text-xl text-black">
                  Welcome to Amader
                  <span className="text-[#FFBE15]"> School</span>!!
                </h1>
                <h1 className="font-bold text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-gray-900 my-5">
                  STUDENT LOGIN
                </h1>
              ...
              <div>
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-8">
                    <label className="text-xs xl:text-[16px] font-semibold px-1">
                      Role
                    </label>
                    <div className="flex">
                      ...
                      <input
                        onSubmit={handleRole}
                        type="text"
                        className="w-full -ml-10 pl-4 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#FFBE15]"
                        value="student"
                        readOnly
                        {...register("role")}
                      />
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-8">
                    ...
                    <div className="flex flex-col">
                      <input
                        type="email"
                        className="w-full pl-4 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-[#FFBE15]"
                ...
                <div className="flex lg:flex-row flex-col xl:flex-row md:flex-row lg:gap-0 xl:gap-0 md:gap-0 gap-3 lg:justify-between md:justify-between xl:justify-between mb-12">
                  <div>
                    <label className="">
                      <Link
                        href="/"
                        className="hover:text-[#FFBE15] hover:underline"
                      >
                        Forgot password?
                      </Link>
                    </label>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button className="block w-full max-w-xs mx-auto bg-[#FFBE15] hover:bg-[#e4af29] focus:bg-indigo-700 text-black rounded-lg px-3 py-3 font-semibold">
                      LOGIN NOW
                    </button>
                  </div>
                </div>
