...
const About = () => {
  return (
    <section className="py-10 md:py-14 lg:py-16 xl:py-20" id="about">
      <div className="container mx-auto grid place-items-center gap-10">
        ...
        <div className="max-w-[500px] md:max-w-[600px] lg:max-w-[700px] xl:max-w-[800px] xl:text-2xl px-5 md:px-0 lg:px-0 xl:px-0">
